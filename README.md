...
- `index.html` — survey application
- `styles.css` — Avante styling using Plus Jakarta Sans
- `app.js` — navigation, conditional service sections, autosave and submission logic
- `config.js` — response endpoint settings
- `avante-logo.webp` — Avante logo

Upload all five website files to the root of the GitHub repository.
